export const elements = {
  ...
  paymentAdvance: document.querySelector("#payment-advance"),
  paymentDirectionField: document.querySelector("#payment-direction-field"),
  paymentDirection: document.querySelector("#payment-direction"),
  paymentConceptField: document.querySelector("#payment-concept-field"),
  paymentConcept: document.querySelector("#payment-concept"),
  ...
  registerAdvance: document.querySelector("#register-advance"),
