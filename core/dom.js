export const elements = {
  ...
  searchConcept: document.querySelector("#search-concept"),
  searchNote: document.querySelector("#search-note"),
  searchParty: document.querySelector("#search-party"),
  searchModal: document.querySelector("#search-modal"),
  openSearchModal: document.querySelector("#open-search-modal"),
  ...
  movementDetailModal: document.querySelector("#movement-detail-modal"),
  movementDetailTitle: document.querySelector("#movement-detail-title"),
  movementDetailAmount: document.querySelector("#movement-detail-amount"),
  movementDetailDate: document.querySelector("#movement-detail-date"),
  movementDetailCategory: document.querySelector("#movement-detail-category"),
  movementDetailRecurrenceRow: document.querySelector("#movement-detail-recurrence-row"),
  movementDetailRecurrence: document.querySelector("#movement-detail-recurrence"),
  movementDetailPartyRow: document.querySelector("#movement-detail-party-row"),
  movementDetailParty: document.querySelector("#movement-detail-party"),
  movementDetailNoteRow: document.querySelector("#movement-detail-note-row"),
  movementDetailNote: document.querySelector("#movement-detail-note"),
  movementDetailShared: document.querySelector("#movement-detail-shared"),
  movementDetailSharedContact: document.querySelector("#movement-detail-shared-contact"),
  movementDetailSharedMode: document.querySelector("#movement-detail-shared-mode"),
  movementDetailSharedSharesRow: document.querySelector("#movement-detail-shared-shares-row"),
  movementDetailSharedShares: document.querySelector("#movement-detail-shared-shares"),
  movementDetailEdit: document.querySelector("#movement-detail-edit"),
  movementDetailDuplicate: document.querySelector("#movement-detail-duplicate"),
  movementDetailDelete: document.querySelector("#movement-detail-delete"),
  closeMovementDetail: document.querySelector("#close-movement-detail"),
};
